...
import (
	"fmt"
	"github.com/monax/peptide/types/gogopb"
	"go/ast"
	"go/parser"
	"go/token"
...
func genGeneratedHeader(gen *protogen.Plugin, g *protogen.GeneratedFile, f *fileInfo) {
	g.P("// Code generated by protoc-gen-go-peptide. DO NOT EDIT. BUMssss")
	...
	if GenerateVersionMarkers {
		...
		g.P("// \tprotoc-gen-go-peptide ", protocGenGoVersion)
...
func genMessageField(g *protogen.GeneratedFile, f *fileInfo, m *messageInfo, field *protogen.Field, sf *structFields) {
	...
	// gogo: moretags
	{
		...
		moreTagsDecl := proto.GetExtension(fieldOpts, gogopb.E_Moretags).(string)
