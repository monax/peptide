...
import (
	...
	"github.com/monax/peptide/internal/errors"
...
type FileImports struct {
	...
	slice []protoreflect.FileImport
}

func (p *FileImports) Len() int                          { return len(p.slice) }
func (p *FileImports) Get(i int) protoreflect.FileImport { return p.slice[i] }
